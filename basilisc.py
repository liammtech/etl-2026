...
from workflows.bom.stocked_to_mto_jpull import switch_jpull_stocked_to_mto, jpull_range_to_mto

from workflows.sku.inventory import create_invmasterplus_record, create_invmasterplus_record_range
from workflows.sku.mrp import reset_mrp, reset_mrp_range
from workflows.sku.restore_linked_stock_codes import restore_linked_sku, restore_linked_skus_range
from workflows.sku.volumetrics import fix_door_volumetrics, fix_door_volumetrics_range
from workflows.sku.warehouse import create_invwarehouse_record, create_invwarehouse_record_range
from workflows.wip.waterford_m2m import populate_waterford_m2ms
...
JOBS = {
    # SKU tools
    "jpull-stocked-to-mto": switch_jpull_stocked_to_mto,
